# Read in the text from below the __END__ line (bottom of file)
...
# creating a table of words and following word probabilities
...
# initializing a sentence array that starts with a random word
